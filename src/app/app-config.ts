...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        'https://skillassuretraining.b2clogin.com/skillassuretraining.onmicrosoft.com/B2C_1_signinsignup',
    },
    resetPassword: {
      authority:
...
export const msalConfig: Configuration = {
  auth: {
    ...
    redirectUri: 'https://app-petzey.dev.skillassure.com/dashboard/allAppintmentDoctor',
